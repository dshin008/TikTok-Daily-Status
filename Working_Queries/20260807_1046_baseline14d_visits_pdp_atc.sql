-- Morning ad group checkup: 14-day baseline (2026-07-19 to 2026-08-01), aggregated
-- id-match first, name-match fallback second
WITH visits AS (
  SELECT
  ...
  WHERE cmcode IN ('TT49BTSUF','TT49BTSMF','TT49NBAU','TT49VSA','TT49DPA','TT49GTMMF',
    ...
    AND sessionstartdate BETWEEN DATE('2026-07-19') AND DATE('2026-08-01')
    AND event_soid = 49
  GROUP BY ALL
),
tiktok_lookup AS (
  ...
  WHERE accountID = "7125498373565726721"
    AND reportDate >= DATE('2026-07-19') - 10
