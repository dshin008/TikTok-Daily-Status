-- Morning ad group checkup: recent 3 settled days (2026-08-02 to 2026-08-04), daily grain
-- Mid/Low funnel decay check (Signal A) — do not pre-aggregate across dates
WITH visits AS (
  SELECT
  ...
  WHERE cmcode IN ('TT49BTSUF','TT49BTSMF','TT49NBAU','TT49VSA','TT49DPA','TT49GTMMF',
    ...
    AND sessionstartdate BETWEEN DATE('2026-08-02') AND DATE('2026-08-04')
    AND event_soid = 49
  GROUP BY ALL
)
SELECT
