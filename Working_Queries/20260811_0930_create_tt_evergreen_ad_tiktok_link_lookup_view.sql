-- Creates Connected Sheets–friendly view for Performance Tracker Ad TikTok Link Lookup
CREATE VIEW `wf-gcp-us-ae-mktg-prod.analysis_paidsocial.tt_evergreen_ad_tiktok_link_lookup` AS
