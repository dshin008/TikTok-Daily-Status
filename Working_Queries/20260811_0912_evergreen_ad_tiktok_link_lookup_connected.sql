-- Connected Sheets source for Performance Tracker → Ad TikTok Link Lookup
-- Billing/project used by other tracker connections: wf-gcp-us-ae-mktg-rpt
-- Grain: one row per TikTok ad_id (Evergreen VSA Broad Web*, last 90 days)
